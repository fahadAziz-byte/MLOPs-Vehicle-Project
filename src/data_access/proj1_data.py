...
class Proj1Data:
    ...
    def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = "Proj1") -> pd.DataFrame:
        """
        ...
        """
        try:
            # Access the correct database object, which is stored in self.mongo_client.database
            db = self.mongo_client.database
            
            print('Mongodb client has been accessed now moving towards getting collections')
